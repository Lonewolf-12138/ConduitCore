package me.lonewolf.conduitcore.render.gui.hudeditorscreen.widget;
 ...
 * @date 2023/5/21 18:07
 * @description TODO
 */

public class FormatTextFieldWidget extends ClickableWidget implements Drawable, Element {
    ...
    private List<Text> tips;

    private int offX;

    private int offY;

    public FormatTextFieldWidget(Screen parentScreen,List<Text> tips ,TextRenderer textRenderer, int x, int y, int width, int height, Text text) {
        this(parentScreen, tips,textRenderer, x, y, width, height, (TextFieldWidget)null, text);
    }

    public FormatTextFieldWidget(Screen parentScreen, List<Text> tips, TextRenderer textRenderer, int x, int y, int width, int height, @Nullable TextFieldWidget copyFrom, Text text) {
    ...
    public void render(MatrixStack matrices, int mouseX, int mouseY, float delta) {
        if (this.visible) {
            ...
            if(isActive()) {
                parentScreen.renderTooltip(matrices, tips, x + width, offY + height * 2);
            }
        }
    }
